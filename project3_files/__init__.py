...
from project3_files import main_functions



cred_dict = main_functions.read_from_file("project3_files/JSON_Documents/credentials.json")
...
from project3_files import routes